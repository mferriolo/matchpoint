                      ...
                      return (
                        ...
                        >
                          ...
                          {isColVisible('company') && (
                            <td className="px-4 py-2.5 border-r border-gray-100 text-gray-900 font-medium text-sm" onClick={e => e.stopPropagation()}>
                              {c.company_name && c.company_id ? (
                                <Popover>
                                  <PopoverTrigger asChild>
                                    <button
                                      type="button"
                                      className="text-left hover:underline decoration-dotted underline-offset-2 inline-flex items-center gap-1.5 max-w-full"
                                      title={`Actions for ${c.company_name}`}
                                    >
                                      <span className="truncate">{c.company_name}</span>
                                      {findingContactsForId === c.company_id && (
                                  ...
                                  <PopoverContent align="start" className="w-64 p-1" onOpenAutoFocus={e => e.preventDefault()}>
                                    ...
                                    <button
                                      ...
                                      disabled={contactRunIsActive || findingContactsForId === c.company_id}
                                      ...
                                      title={contactRunIsActive ? 'A contact run is already in progress' : `Rescan ${c.company_name} for new hiring contacts (AI + Crelate)`}
                                    >
                                      {findingContactsForId === c.company_id
